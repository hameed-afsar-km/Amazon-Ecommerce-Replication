...
document.querySelectorAll('.delivery-option-input').forEach((input) => {
    input.addEventListener('change', (e) => {
        ...
        const productId = e.target.name.replace('delivery-option-', '');
        ...
        const newDate = dayjs().add(selectedOption.deliveryDays, 'days');
        deliveryDateElement.textContent = `Delivery date: ${newDate.format('dddd, MMMM D')}`;
    });
});
